    ...
    cards: {
        ...
        default: () => [
            ...
            },
            {
                route: "atlas",
                title: "精灵图鉴",
                description: "按编号查看全部精灵、各种形态与首领形态。",
            },
            {
                route: "skills",
                title: "技能图鉴",
                description: "查看全部技能、技能属性、分类与可学习精灵。",
            },
        ],
    },
});
        ...
        <section class="home-tools">
            <div class="home-card-grid">
                ...
                >
                    ...
                    <button
                        type="button"
                        class="home-tool-button"
                        @click="openCard(item.route)"
                    >
                        <span>打开</span>
...
.home-page {
    ...
    --home-glass-dark-bg: linear-gradient(
        180deg,
        rgba(15, 23, 42, 0.34),
        rgba(15, 23, 42, 0.16)
    );
...
.home-tool-card-5 .home-tool-card-bg {
    background: radial-gradient(
        circle,
        rgba(34, 197, 94, 0.24),
        transparent 68%
...
.home-tool-card-6 .home-tool-card-bg {
    background: radial-gradient(
        circle,
